...
const Practice = () => {
  ...
  const handleSelectAnswer = (answer) => {
    ...
    // Simple if statement to check if answer is correct
  ...
  return (
    <div className="page-container">
      ...
      <div className="bg-white shadow-lg rounded-xl p-8 border border-gray-100 mb-8 max-w-3xl mx-auto">
            ...
            <button
              ...
              className={
                selectedAnswer === option ? 
                  isCorrect ? 'w-full text-left p-4 rounded-lg border bg-green-50 border-green-300' 
                  : 'w-full text-left p-4 rounded-lg border bg-red-50 border-red-300'
                  : 'w-full text-left p-4 rounded-lg border hover:bg-gray-50 border-gray-200'
              }
        ...
        {isAnswered && (
          <div className={
            isCorrect ? "mb-6 p-4 rounded-lg bg-green-50 border border-green-200" 
